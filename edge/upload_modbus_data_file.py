...
udp_upload_ais = gateway.link.SqlFileModbusData(
    ...
    message_formats = [ {"message": {"type":"FC03", "start_pos":0},
                     ...
                     "P1":   { "bits":[ 20, 21], "type":"f", "round":2 },
                     "P2":   { "bits":[ 22, 23], "type":"f", "round":2 },
                     "P3":   { "bits":[ 24, 25], "type":"f", "round":2 },
                     "S1":   { "bits":[ 26, 27], "type":"f", "round":2 },
                     "S2":   { "bits":[ 28, 29], "type":"f", "round":2 },
                     "S3":   { "bits":[ 30, 31], "type":"f", "round":2 },
                     "Q1":   { "bits":[ 32, 33], "type":"f", "round":2 },
                     "Q2":   { "bits":[ 34, 35], "type":"f", "round":2 },
                     "Q3":   { "bits":[ 36, 37], "type":"f", "round":2 },
                     ...
                     "P":    { "bits":[ 50, 51], "type":"f", "round":2 },
                     "S":    { "bits":[ 52, 53], "type":"f", "round":2 },
                     "Q":    { "bits":[ 54, 55], "type":"f", "round":2 },
