...
while (True):
    ...
    for channel_index in {140,141,160,161,180,181}:
        ...
        files = timefiles.get_all_files(env['STORE_PATH'], ['jpg','png'], channel_index)
        ...
        if len(files) > 0:
            ...
            try:
                ...
                for current_file in files:
                    ...
                    if len(files) > 0: #if acquired_time < int(time.time()) - 2*1.0/1.0 :
